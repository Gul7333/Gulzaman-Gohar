...
function Mywebsites() {
  ...
  return (
    ...
    <div>
        ...
        <span style={{marginLeft: "2em", display : 'block' ,marginTop: "5px", }}>A website which gives detail and description of medicines.</span>
    </div>
    <div>
        ...
        <span style={{marginLeft: "2em", display : 'block' ,marginTop: "5px",}}>A website which provides uptodate prices of medicines in pakistan.</span>
    </div>
    <div>
        ...
        <span style={{marginLeft: "2em", display : 'block' ,marginTop: "5px", }}>A bubble game which i made during practice of javascript.</span>
    </div>
    <div>
        ...
        <span style={{marginLeft: "2em", display : 'block' ,marginTop: "5px", }}>A Beautifull analog Clock i made during practice of web learning.</span>
    </div>
