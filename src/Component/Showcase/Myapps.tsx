...
function Myapps() {
  ...
  return (
    ...
    <div>
        ...
        <span style={{marginLeft: "2em", display : 'block' ,marginTop: "5px"}}>An App which showcases Books of SARKAR RIAZ AHMED GOHAR SHAHI.</span>
    </div>
    <div>
        ...
        <span style={{marginLeft: "2em", display : 'block' ,marginTop: "5px"}}>An app which gives uptodate price and detail of drug .</span>
    </div>
    </div>
